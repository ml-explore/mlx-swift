...
class MLXArrayIndexingTests: XCTestCase {
    ...
    public func testExpandEllipsisOperations() {
        ...
        let operations4: [MLXArrayIndexOperation] = [.newAxis, .index(0), .ellipsis, .index(0), .newAxis]
    ...
    func check(_ result: MLXArray, _ shape: [Int], _ sum: Int, file: StaticString = #filePath, line: UInt = #line) {
    ...
    public func testFullIndexReadNoArray() {
        ...
        // a[::-1, :2, 2:, ..., None, ::2]
        check(a[.stride(by: -1), ..<2, 2..., .ellipsis, .newAxis, .stride(by: 2)], [2, 2, 2, 5, 1, 2], 13160)
    }
    ...
    public func testFullIndexReadArray() {
        ...
        // a[::-1, :2, i, 2:, ..., None, ::2]
        check(a[.stride(by: -1), ..<2, i, 2..., .ellipsis, .newAxis, .stride(by: 2)], [3, 2, 2, 3, 1, 2], 17460)
    }
