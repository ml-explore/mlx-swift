...
public func jvp(_ f: @escaping ([MLXArray]) -> [MLXArray], primals: [MLXArray], tangents: [MLXArray]) -> ([MLXArray], [MLXArray]) {
...
public func vjp(_ f: @escaping ([MLXArray]) -> [MLXArray], primals: [MLXArray], cotangents: [MLXArray]) -> ([MLXArray], [MLXArray]) {
...
public func valueAndGrad(_ f: @escaping (NestedDictionary<String, MLXArray>, [MLXArray]) -> [MLXArray], argumentNumbers: [Int] = [0]) -> (NestedDictionary<String, MLXArray>, [MLXArray]) -> ([MLXArray], [MLXArray]) {
