...
func buildValueAndGradient(_ f: @escaping ([MLXArray]) -> [MLXArray], argumentNumbers: [Int]) -> ([MLXArray]) -> [MLXArray] {
...
private func new_mlx_closure(_ f: @escaping ([MLXArray]) -> [MLXArray]) -> mlx_closure {
    ...
    func trampoline(vector_array: mlx_vector_array?, payload: UnsafeMutableRawPointer?) -> mlx_vector_array? {
